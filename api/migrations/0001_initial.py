    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='session_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.sessiontype'),
        ),
        migrations.AddField(
            model_name='sessionrequest',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_requests', to='api.user'),
        ),
        migrations.AddField(
            model_name='sessionrequest',
            name='tutor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tutor_requests', to='api.user'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback_given', to='api.user')),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback_received', to='api.user')),
            ],
        ),
        migrations.CreateModel(
